...
function AddCustomerSession({ thisSession, closed }) {
  ...
  const handleSelectSession = (id) => {
    setSelectSession(findItemById(activeSessions, id));
  };
  ...
  if (session) {
    ...
    return (
      <div className="selectorSession">
        <h3>Sélectionner une session</h3>
...
AddCustomerSession.propTypes = {
  session: PropTypes.object,
};

export default AddCustomerSession;
